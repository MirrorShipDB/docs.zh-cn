...
+ 参考手册
  + SQL参考
    ...
    + [DDL](/reference/DDL.md)
      + [ALTER DATABASE](./sql-reference/sql-statements/data-definition/ALTER%20DATABASE.)
      + [DROP DATABASE](./sql-reference/sql-statements/data-definition/DROP%20DATABASE.)
      + [ALTER TABLE](./sql-reference/sql-statements/data-definition/ALTER%20TABLE.)
      + [DROP INDEX](./sql-reference/sql-statements/data-definition/CREATE%20INDEX.)
      + [ALTER VIEW](./sql-reference/sql-statements/data-definition/ALTER%20VIEW.)
      + [DROP MATERIALIZED VIEW](./sql-reference/sql-statements/data-definition/DROP%20MATERIALIZED%20VIEW.)
      + [BACKUP](./sql-reference/sql-statements/data-definition/BACKUP.)
      + [DROP REPOSITORY](./sql-reference/sql-statements/data-definition/DROP%20REPOSITORY.)
      + [CANCEL ALTER](./sql-reference/sql-statements/data-definition/CANCEL%20ALTER.)
      + [DROP RESOURCE](./sql-reference/sql-statements/data-definition/DROP%20RESOURCE.)
      + [CANCEL BACKUP](./sql-reference/sql-statements/data-definition/CANCEL%20BACKUP.)
      + [DROP TABLE](./sql-reference/sql-statements/data-definition/DROP%20TABLE.)
      + [CANCEL RESTORE](./sql-reference/sql-statements/data-definition/CANCEL%20RESTORE.)
      + [DROP VIEW](./sql-reference/sql-statements/data-definition/DROP%20VIEW.)
      + [CREATE DATABASE](./sql-reference/sql-statements/data-definition/CREATE%20DATABASE.)
      + [HLL](./sql-reference/sql-statements/data-definition/HLL.)
      + [CREATE INDEX](./sql-reference/sql-statements/data-definition/CREATE%20INDEX.)
      + [RECOVER](./sql-reference/sql-statements/data-definition/RECOVER.)
      + [CREATE MATERIALIZED VIEW](./sql-reference/sql-statements/data-definition/CREATE%20MATERIALIZED%20VIEW.)
      + [RESTORE](./sql-reference/sql-statements/data-definition/RESTORE.)
      + [CREATE REPOSITORY](./sql-reference/sql-statements/data-definition/CREATE%20REPOSITORY.)
      + [SHOW RESOURCES](./sql-reference/sql-statements/data-definition/SHOW%20RESOURCES.)
      + [CREATE RESOURCE](./sql-reference/sql-statements/data-definition/CREATE%20RESOURCE.)
      + [TRUNCATE TABLE](./sql-reference/sql-statements/data-definition/TRUNCATE%20TABLE.)
      + [CREATE TABLE LIKE](./sql-reference/sql-statements/data-definition/CREATE%20TABLE%20LIKE.)
    + [DML](/reference/DML.md)
      + [ALTER ROUTINE LOAD](./sql-reference/sql-statements/data-manipulation/alter-routine-load.)
      + [BROKER LOAD](./sql-reference/sql-statements/data-manipulation/BROKER%20LOAD.)
      + [CANCEL LOAD](./sql-reference/sql-statements/data-manipulation/CANCEL%20LOAD.)
      + [DELETE](./sql-reference/sql-statements/data-manipulation/DELETE.)
      + [EXPORT](./sql-reference/sql-statements/data-manipulation/EXPORT.)
      + [GROUP BY](./sql-reference/sql-statements/data-manipulation/GROUP%20BY.)
      + [INSERT](./sql-reference/sql-statements/data-manipulation/insert.)
      + [PAUSE ROUTINE LOAD](./sql-reference/sql-statements/data-manipulation/PAUSE%20ROUTINE%20LOAD.)
      + [RESUME ROUTINE LOAD](./sql-reference/sql-statements/data-manipulation/RESUME%20ROUTINE%20LOAD.)
      + [ROUTINE LOAD](./sql-reference/sql-statements/data-manipulation/ROUTINE%20LOAD.)
      + [SELECT]
      + [SHOW ALTER](./sql-reference/sql-statements/data-manipulation/SHOW%20ALTER.)
      + [SHOW BACKUP](./sql-reference/sql-statements/data-manipulation/SHOW%20BACKUP.)
      + [SHOW DATA](./sql-reference/sql-statements/data-manipulation/SHOW%20DATA.)
      + [SHOW DATABASES](./sql-reference/sql-statements/data-manipulation/SHOW%20DATABASES.)
      + [SHOW DELETE](./sql-reference/sql-statements/data-manipulation/SHOW%20DELETE.)
      + [SHOW DYNAMIC PARTITION TABLES](./sql-reference/sql-statements/data-manipulation/SHOW%20DYNAMIC%20PARTITION%20TABLES.)
      + [SHOW EXPORT](./sql-reference/sql-statements/data-manipulation/SHOW%20EXPORT.)
      + [SHOW LOAD](./sql-reference/sql-statements/data-manipulation/SHOW%20LOAD.)
      + [SHOW PARTITIONS](./sql-reference/sql-statements/data-manipulation/SHOW%20PARTITIONS.)
      + [SHOW PROPERTY](./sql-reference/sql-statements/data-manipulation/SHOW%20PROPERTY.)
      + [SHOW REPOSITORIES](./sql-reference/sql-statements/data-manipulation/SHOW%20REPOSITORIES.)
      + [SHOW RESTORE](./sql-reference/sql-statements/data-manipulation/SHOW%20RESTORE.)
      + [SHOW ROUTINE LOAD](./sql-reference/sql-statements/data-manipulation/SHOW%20ROUTINE%20LOAD.)
      + [SHOW ROUTINE LOAD TASK](./sql-reference/sql-statements/data-manipulation/SHOW%20ROUTINE%20LOAD%20TASK.)
      + [SHOW SNAPSHOT](./sql-reference/sql-statements/data-manipulation/SHOW%20SNAPSHOT.)
      + [SHOW TABLES](./sql-reference/sql-statements/data-manipulation/SHOW%20TABLES.)
      + [SHOW TABLET](./sql-reference/sql-statements/data-manipulation/SHOW%20TABLET.)
      + [SHOW TRANSACTION](./sql-reference/sql-statements/data-manipulation/SHOW%20TRANSACTION.)
      + [SPARK LOAD](./sql-reference/sql-statements/data-manipulation/SPARK%20LOAD.)
      + [STOP ROUTINE LOAD](./sql-reference/sql-statements/data-manipulation/STOP%20ROUTINE%20LOAD.)
      + [STREAM LOAD](./sql-reference/sql-statements/data-manipulation/STREAM%20LOAD.)
    + [辅助命令](/reference/Auxiliary.md)
      + [DESCRIBE](./sql-reference/sql-statements/Utility/DESCRIBE.)
