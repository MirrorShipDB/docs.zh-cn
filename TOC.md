...
+ 参考手册
  + SQL参考
    + [用户账户管理](/reference/Account_reference.md)
      + [ALTER USER](./sql-reference/sql-statements/account-management/ALTER USER.md)
      + [CREATE ROLE](./sql-reference/sql-statements/account-management/CREATE ROLE.md)
      + [CREATE USER](./sql-reference/sql-statements/account-management/CREATE USER.md)
      + [DROP ROLE](./sql-reference/sql-statements/account-management/DROP ROLE.md)
      + [DROP USER](./sql-reference/sql-statements/account-management/DROP USER.md)
      ...
      + [SET PASSWORD](./sql-reference/sql-statements/account-management/SET PASSWORD.md)
      + [SET PROPERTY](./sql-reference/sql-statements/account-management/SET PROPERTY.md)
      + [SHOW GRANTS](./sql-reference/sql-statements/account-management/SHOW GRANTS.md)
      + [SHOW ROLES](./sql-reference/sql-statements/account-management/SHOW ROLES.md)
    ...
    + [DDL](/reference/DDL.md)
      ...
      + [CREATE TABLE](./sql-reference/sql-statements/data-definition/CREATE TABLE.md)
      + [CREATE VIEW](./sql-reference/sql-statements/data-definition/CREATE VIEW.md)
      ...
      + [DROP INDEX](./sql-reference/sql-statements/data-definition/DROP INDEX.md)
